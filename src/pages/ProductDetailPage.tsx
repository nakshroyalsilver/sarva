          ...
          <div className="lg:w-[60%] flex flex-col gap-8 pb-20">
            ...
            <div>
              ...
              <div className="flex gap-3 h-12">
                 ...
                 <button onClick={handleAddToCart} className={`flex-1 font-bold uppercase tracking-widest text-sm rounded-lg transition-all shadow-sm flex items-center justify-center gap-2 border ${isAdded ? "bg-green-600 text-white border-green-600" : "bg-white text-rose-600 border-rose-600 hover:bg-rose-50"}`}>
                   {isAdded ? <>Added <Check size={18} /></> : <>Add to Cart <ShoppingBag size={18}/></>}
                 </button>

                 <button onClick={handleBuyNow} className="flex-1 bg-rose-600 text-white font-bold uppercase tracking-widest text-sm rounded-lg hover:bg-rose-700 transition-all shadow-lg shadow-rose-200">
                   Buy Now
                 </button>
              </div>
            </div>
